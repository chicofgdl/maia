...
export default function Sidebar() {
  ...
  const isActive = (path: string) =>
    pathname === path ? "bg-gray-700" : "bg-gray-500";

  return (
    <div className="h-full flex flex-col justify-between">
      <div className="flex flex-col gap-20">
        <div className="h-30 rounded-xl flex flex-col items-center justify-center bg-gray-600 p-4">
        ...
        <div className="flex flex-col gap-4">
          <Link href="/">
            <div
              className={`${isActive(
                "/"
              )} font-bold hover:bg-gray-600 text-white h-12 rounded-xl flex items-center justify-start px-4 g-2`}
            >
