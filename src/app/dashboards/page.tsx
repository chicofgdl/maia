        ...
        return selectedEmployeeData
            ? {
                  ...
                  datasets: [
                      {
                          data: [
                              selectedEmployeeData.tasksDone,
                              selectedEmployeeData.tasksTotal -
                                  selectedEmployeeData.tasksDone,
                          ],
        ...
        return (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full h-full">
                <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col items-center w-full max-w-4xl">
                    <h3 className="text-lg font-bold mb-4 text-white bg-[#4C8CE6] w-full flex p-2 justify-center rounded-xl">
                        Aproveitamento do Funcionário
                    </h3>
                ...
                <div className="flex flex-col gap-4 w-full">
                    <div className="bg-white p-4 rounded-xl shadow-lg text-center w-full">
                        <h3 className="text-md font-bold mb-2 text-black">
                            Progresso do Funcionário
                        </h3>
                        <Progress value={selectedEmployeeData.progress} className="text-[#4C8CE6] font-bold"/>
                    </div>
                    <div className="bg-white p-4 rounded-xl shadow-lg text-center w-full">
                        <h3 className="text-md font-bold mb-2 text-black">
                            Perguntas feitas à MAIA
                        </h3>
                        <p className="text-[#4C8CE6] font-bold">{selectedEmployeeData.questionsAsked}</p>
                    </div>
                    <div className="bg-white p-4 rounded-xl shadow-lg text-center w-full">
                        <h3 className="text-md font-bold mb-2 text-black">
                            Data de Início do Onboarding
                        </h3>
                        <p className="text-[#4C8CE6] font-bold">{selectedEmployeeData.dataInicio}</p>
                    </div>
                    <div className="bg-white p-4 rounded-xl shadow-lg text-center w-full">
                        <h3 className="text-md font-bold mb-2 text-black">
                            Data de Fim do Onboarding
                        </h3>
                        <p className="text-[#4C8CE6] font-bold">{selectedEmployeeData.dataFim}</p>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="w-full h-screen flex bg-gray-700 p-6 gap-4 justify-center">
            ...
            <div className="w-full bg-gray-800 p-4 rounded-2xl">
                ...
                <div className="flex flex-col md:flex-row gap-6 mb-6 text-black">
                    <select
                        onChange={handleCompanyChange}
                        className="p-3 rounded-lg bg-white shadow w-full"
                    >
                        <option value="">
                            Selecione uma empresa que você administra
                        </option>
                    ...
                    >
                        <option value="">
                            Selecione um funcionário da empresa escolhida
                        </option>
