...
const Profile = () => {
    ...
    return (
        <div className="w-full h-screen flex bg-gray-700 p-6 gap-6 justify-center">
            ...
            <div className="w-full bg-gray-800/50 p-6 rounded-2xl overflow-y-auto" style={{ scrollbarWidth: "none" }}>
                <h1 className="text-2xl font-bold mb-6 bg-[#4C8CE6] rounded-xl p-2 flex justify-center text-white">
                    Perfil
                </h1>
                <div className="bg-slate-400 p-6 rounded-xl shadow-lg flex gap-6">
                    ...
                    <div className="flex-1 text-black">
                        ...
                        <p>
                            <strong>Cargo:</strong> {mockUserProfile.role}
                        </p>
                        <p>
                ...
                {selectedCompany && (
                    <div className="mt-6 bg-white p-4 rounded-xl shadow-lg cursor-pointer">
                        <h3 className="text-xl font-semibold mb-4 flex justify-center font-bold mb-6 bg-green-900/70 rounded-xl p-2 flex text-white">
                            Funcionários
                        </h3>
